  ...
  card.innerHTML = `
    ...
    <div class="why-card">
      ...
      <span class="confidence-badge conf-${(data.why_card.confidence || "Medium").toLowerCase()}">
        ...
        ${data.why_card.source && data.why_card.source !== "claude" ? infoBtn("ruleBasedCard") : ""}
      </span>
    </div>
...
const INFO_TEXTS = {
  ...
  ruleBasedCard: "This analysis was generated by the rule engine, not the AI model.\n\nThat happens when:\n• No API key is configured\n• The AI call timed out (>8s)\n• The AI returned an unparseable response\n\nThe numbers and rating are identical — only the written explanation differs. Rule-based bullets follow fixed templates; AI bullets are more context-aware.",
};
